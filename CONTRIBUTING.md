...
a [bug report](https://github.com/node-red-contrib-utils/node-red-contrib-file-buffer/issues).
...
* Fork [this repo](https://github.com/node-red-contrib-utils/node-red-contrib-file-buffer)
* Clone the project
* Create an npm link to your forked project
  * Within the cloned directory, run `npm link`
  * Within the Node-RED directory, run `npm link node-red-contrib-file-buffer`
* Run Node-RED
